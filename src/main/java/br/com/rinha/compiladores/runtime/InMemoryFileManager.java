...
public class InMemoryFileManager extends ForwardingJavaFileManager<JavaFileManager> {
    ...
    /**
     * Used to get the class loader for our compiled class. It creates an anonymous
     * class extending the SecureClassLoader which uses the byte code created by the
     * compiler and stored in the JavaClassObject, and returns the Class for it
     *
